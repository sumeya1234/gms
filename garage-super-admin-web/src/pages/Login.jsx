      ...
      <div className="w-full max-w-md bg-white border border-slate-100 rounded-[2.5rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] relative z-10 overflow-hidden">
        ...
        <div className="p-8 sm:p-10">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-black text-slate-900 tracking-tight">GMS Admin Portal</h1>
            <p className="text-slate-500 mt-2 font-medium">Sign in to manage the system</p>
          </div>
