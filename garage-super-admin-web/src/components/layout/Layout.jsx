...
export const Layout = () => {
    ...
    const navItems = [
        ...
        { path: '/garages', label: t('garages'), icon: Building2 },
        { path: '/users', label: t('users'), icon: Users },
        { path: '/managers', label: t('managers'), icon: Briefcase },
        { path: '/complaints', label: t('systemComplaints'), icon: AlertTriangle },
    ];
            ...
            <aside className="h-screen w-64 fixed left-0 top-0 bg-white flex flex-col py-8 px-4 z-40 transition-all border-r border-slate-200">
                ...
                <div className="mb-10 px-2">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-black text-[#1890ff] tracking-tighter leading-none">{t('gmsAdmin')}</h1>
                ...
                <nav className="flex-1 space-y-1">
                    <p className="text-[10px] uppercase tracking-widest text-slate-400 font-bold mb-4 px-4">{t('navigation')}</p>
                ...
                <header className="fixed top-0 right-0 w-[calc(100%-16rem)] h-16 z-30 bg-white/95 backdrop-blur-md flex justify-between items-center px-8 shadow-sm border-b border-slate-200">
                    ...
                    <div className="flex items-center gap-4 relative">
                        ...
                        <div className="flex items-center gap-3 bg-slate-100 rounded-full px-4 py-1.5 border border-slate-200">
                            ...
                            <span className="text-xs font-bold text-gray-900">{t('superAdminRole')}</span>
                        </div>
                    </div>
                </header>
