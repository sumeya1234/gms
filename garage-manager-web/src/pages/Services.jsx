  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold text-[var(--color-primary)]">Services & Inventory</h1>
          <p className="text-gray-500 mt-1">Manage your physical parts in stock and available labor services.</p>
        </div>
          ...
          <div className="flex">
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-yellow-700">
                <p>The following items are running low (under 10 items):</p>
                <ul className="list-disc pl-5 mt-1 space-y-1">
                  {inventory.filter(item => item.Quantity < 10).map(item => (
                    <li key={item.ItemID}>
                      <span className="font-semibold">{item.ItemName}</span> - Only {item.Quantity} left
                    </li>
                  ))}
                </ul>
              </div>
      ...
      <div className="card overflow-hidden">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-56 text-gray-500 bg-gray-50/50">
            ...
            <p className="font-medium text-gray-600 text-lg">No services or inventory items found.</p>
            <p className="text-sm mt-1">Add items like "Brake Pads" or services like "Oil Change" to get started.</p>
          </div>
        ) : (
            ...
            <table className="w-full text-left border-collapse min-w-[700px]">
              <thead>
                <tr className="bg-gray-50/80 border-b border-[var(--color-border)] text-sm text-[var(--color-text-light)]">
                  ...
                  <th className="p-4 font-semibold">Service / Part Name</th>
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleSubmit} className="p-6" autoComplete="off">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-1">Service / Part Name</label>
                  <input
                    type="text"
                    name="itemName"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                    />
                    <p className="text-[10px] text-gray-500 mt-1">Use 999+ for limitless labor services.</p>
                  </div>
