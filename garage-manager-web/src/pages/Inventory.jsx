...
export default function Inventory() {
  ...
  if (userRole !== 'GarageManager' && userRole !== 'GarageOwner') {
    return (
      <div className="card p-6">
        <h1 className="text-2xl font-bold text-[var(--color-primary)] mb-2">{t('inventoryManagement')}</h1>
        <p className="text-gray-600">Inventory updates are restricted to Garage Managers.</p>
      </div>
    );
  }
