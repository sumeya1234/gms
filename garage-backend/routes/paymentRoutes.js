...
router.put("/confirm-cash/:requestId", protect, authorize("GarageManager"), confirmCash);
router.put("/confirm-online/:requestId", protect, authorize("GarageManager"), confirmOnline);
